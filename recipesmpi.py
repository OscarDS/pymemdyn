...
class BasicEquilibration(object):
    def __init__(self, **kwargs):
        ...
        self.recipe = {
            ...
            "mdrun": {"gromacs": "mdrun",  # 6  this is weird it should be mdrun_mpi, but it IS mdrun.
                      "options": {"dir": "eq",
                                  "src": "topol.tpr",
                                  "tgt": "traj.trr",
                                  "energy": "ener.edr",
    ...
    def __init__(self, **kwargs):
        ...
        for const in range(800, 0, -200):
            ...
            self.recipe["mdrun%d" % const] = \
                {"gromacs": "mdrun",  # 3, 6, 9, 12  AGAIN WEIRD
                 "options": {"dir": tgt_dir,
                             "src": "topol.tpr",
                             "tgt": "traj.trr",
                             "energy": "ener.edr",
