...
\item{Similarly, in that file you specify which queuing system you are
  ...
  your system.  You can also choose  not to use any  queuing system to
  run pymemdyn for testing in standalone in your desktop.}
\end{enumerate}
...
To summarize, the following command should work for the most complex case,
